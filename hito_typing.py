...
class Practice1():
    ...
    def keybind(self):
        global word
        # if word[0] == "1":
        #    canvas.itemconfig("1", fill="pink")
        #    canvas.itemconfig("Lko", fill="pink")
        # elif word[0] == "2":
        #    canvas.itemconfig("2", fill="pink")
        #    canvas.itemconfig("Lkusuri", fill="pink")
        # elif word[0] == "3":
        #    canvas.itemconfig("3", fill="pink")
        #    canvas.itemconfig("Lnaka", fill="pink")
        # elif word[0] == "4":
        #    canvas.itemconfig("4", fill="pink")
        #    canvas.itemconfig("Lhito", fill="pink")
        # elif word[0] == "5":
        #    canvas.itemconfig("5", fill="pink")
        #    canvas.itemconfig("Lhito", fill="pink")
        # elif word[0] == "6":
        #    canvas.itemconfig("6", fill="pink")
        #    canvas.itemconfig("Rhito", fill="pink")
        # elif word[0] == "7":
        #    canvas.itemconfig("7", fill="pink")
        #    canvas.itemconfig("Rhito", fill="pink")
        # elif word[0] == "8":
        #    canvas.itemconfig("8", fill="pink")
        #    canvas.itemconfig("Rnaka", fill="pink")
        # elif word[0] == "9":
        #    canvas.itemconfig("9", fill="pink")
        #    canvas.itemconfig("Rkusuri", fill="pink")
        # elif word[0] == "0":
        #    canvas.itemconfig("zero", fill="pink")

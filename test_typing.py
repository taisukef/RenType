...
class Test_key():
    def __init__(self):
        ...
        back_button = tk.Button(self.master, text="終了", font=(
...
# 打って欲しいキーと四角形を連動させるには
    ...
    def keypush(self, event):
        ...
        if self.word[0] == key:  # 押した時の処理　
            # HajimeteProgramさんのプログラムを参照
    ...
    def end(self):
        ...
        t_result = int(self.t_end - self.start_time)
        with open('test_data.dat', 'a')as f:
            print(nowtime, '', nowtime.day, '', t_result, file=f)
